...
White LED´s use energy to lite up the full visibly spectrum. The Red and Blue only one wavelentht(area) and  is terefore cooler in use. The difference  between the red and blue wavelength  is another matter. 
...
Inside the lamp another 3 eg. 60mm fans can be mounted. This all  depennds on the enclosure design. The fans will be controlled by a common PWM puls.
 ...
 To connecta a 120mm fan as the front cooller,  you need the adabtor 3D print  file.
